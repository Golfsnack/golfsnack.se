...
ActiveRecord::Schema.define(version: 20_210_407_183_955) do
  ...
  create_table 'subscriptions', force: :cascade do |t|
    ...
    t.index %w[target_type target_id key], name: 'index_subscriptions_on_target_type_and_target_id_and_key',
                                           unique: true
    t.index %w[target_type target_id], name: 'index_subscriptions_on_target'
  end
